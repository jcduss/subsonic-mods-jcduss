...
<table class="indent" style="border-spacing:3pt">
    ...
    <tr>
        <td><fmt:message key="playersettings.url"/></td>
        <td><form:input path="url" size="16"/></td>
        <td colspan="2"><c:import url="helpToolTip.jsp"><c:param name="topic" value="playerurl"/></c:import></td>
    </tr>
