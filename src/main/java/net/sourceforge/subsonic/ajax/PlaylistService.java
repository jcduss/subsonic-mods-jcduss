...
public class PlaylistService {
    ...
    private PlaylistInfo convert(HttpServletRequest request, Player player, boolean sendM3U, int offset) throws Exception {
        ...
        // jcduss : VLC remote player : added playlist.vlcPlaylistOperation
        return new PlaylistInfo(entries, playlist.getIndex(), isStopEnabled, playlist.isRepeatEnabled(), sendM3U, gain, playlist.getVlcPlaylistOperation());
