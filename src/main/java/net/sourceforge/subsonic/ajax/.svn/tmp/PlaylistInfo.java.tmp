...
public class PlaylistInfo {
    ...
    private final String vlcPlaylistOperation;
    
    // jcduss : VLC remote player : added vlcPlaylistOperation
    public PlaylistInfo(List<Entry> entries, int index, boolean stopEnabled, boolean repeatEnabled, boolean sendM3U, float gain, String vlcPlaylistOperation) {
        ...
        this.gain = gain;
        // jcduss : VLC remote player
        this.vlcPlaylistOperation = vlcPlaylistOperation;
    }
    // jcduss : VLC remote player
    public String getVlcPlaylistOperation() {
        return vlcPlaylistOperation;
    }
